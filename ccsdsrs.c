/* $Header: /home/karn/ace_rcs/RCS/ccsdsrs.c,v 1.3 2000/01/04 07:53:00 karn Exp $ */
/*
 * Reed-Solomon coding and decoding
 * Phil Karn (karn@ka9q.ampr.org) September 1996
 * 
 * This version implements the (255,223) RS code over GF(256)
 * in the CCSDS specification - Dec 1998 P. Karn
...
/* Index of the first root of the CCSDS generator polynomial */
#define B0	112

/* Exponent of alpha used as the basis for the CCSDS generator polynomial roots
 * I.e., the roots of the generator polynomial are
 ...
 */
unsigned char taltab[NN+1],tal1tab[NN+1];
